...
export async function GET() {
  ...
  try {
    ...
    const response = NextResponse.json({
      sleep: sleep.map((s) => ({ average_hrv: s.average_hrv, day: s.day, bedtime_start: s.bedtime_start, bedtime_end: s.bedtime_end, total_sleep_duration: s.total_sleep_duration, latency: s.latency })),
